...
const prodList = [
  ...
  //----
  {
    ...
    organoleptica: {
      ...
      aroma:
        "Sutil sensación alcohólica, suave al olfato, fresco con notas aromáticas de madera, agave cocido, manzana y ciruela.",
      gusto:
        "Balance perfecto, además consistente promesa entre cuerpo, aroma y sabor, notas claras adquiridas durante su maduración como son madera, caramelo, especias y frutas.",
    },
  },
  //----
  {
  ...
  //----
  {
    ...
    organoleptica: {
      ...
      gusto:
        "Excelente tequila blanco, al degustar por el paladar tiene un sabor fino y duradero a agave selecto",
    },
  },
  //----
  {
    ...
    organoleptica: {
      ...
      gusto:
        "El primer trago envuelve el paladar con una entrada sutíl y untuosa, dejando notas de hierbas y cítricos.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      ...
      aroma:
        "Sutil sensación alcohólica, fresco con delicadas notas de agave, y larga permanencia en la boca.",
  ...
  //----
  {
    ...
    organoleptica: {
      color:
        "Blanco cristalino, brillante, natural con destellos de hojuelas de plata.",
      aroma:
        "Sutil sensación alcohólica, fresco con delicadas notas de agave, y larga permanencia en la boca. Balance perfecto entre sabor y aroma.",
      gusto:
        "Amable y suave con notas cítricas, la persistencia que tiene es media alta y su retrogusto es noble.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      color:
        "Ámbar de alta densidad, muy brillante y con destellos de hojuelas de oro, es untuoso.",
      aroma:
        "Con notas a cítricos como naranja y maracuyá a su vez toques herbáceos a eucalipto, así como membrillo, frutos secos, dátiles y aromas a canela y cacao con una intensidad aromática media alta y un carácter elegante.",
      gusto:
        "El primer ataque intenso y muy potente, rearmando en boca los aromas de guayaba y eucalipto, con persistencia alta y buena intensidad. Su retrogusto es largo y cremoso con notas minerales y especias a canela, clavo y comino.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      color:
        "Color tabaco con tonalidades caoba y destellos de ambarino. Brillante y untuoso con una densidad media alta.",
      aroma:
        "Expresivo y potente, con intensidad aromática a guayaba, caramelos, piloncillo, vainilla, café, cacao y notas especiadas de clavo.",
      gusto:
        "Buen ataque con recuerdos de frutos del bosque, cerezas, madera con persistencia media alta, resaltando la pimienta en retrogusto elegante, resaltando especias y un rico toque a clavo.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      color:
        "Tonalidades cristalinas con hojuelas de plata Cristalino, brillante y natural.",
      aroma:
        "Fresco con delicadas notas de agave. Intensidad aromática media y carácter herbal.",
      gusto:
        "Amable y suave con notas cítricas evolucionando a notas tostadas y minerales. Larga permanencia en la boca.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      color:
        "Ambar de alta intensidad, muy brillantes y con destellos de hojuelas de oro, es untuoso.",
      aroma: "Notas aromáticas marcadas a madera, agave cocido y frutos secos.",
      gusto:
        "Intenso y potente, con persistencia alta y buena intensidad. Con notas minerales y especias a canela, clavo y comino.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      ...
      aroma:
        "Notas aromáticas marcadas a madera, especias, frutos secos y dulce. Con un cuerpo robusto.",
      gusto:
        "Recuerdos de frutos del bosque, cerezas, madera con persistencia media alta, resaltando la pimienta en el retrogusto elegante.",
    },
  },
  //----
  {
    ...
    organoleptica: {
      ...
      aroma:
        "Con notas ahumadas, frescas, herbales y sutilmente frutales, además de delicadas notas dulces.",
      gusto:
        "Sensación de suavidad al paladar que demuestra una agradable experiencia con una majestuosa permanencia en nuestra boca que deleita nuestros sentidos.",
    },
  },
  //----
  {
    foto: "img/productos/tequila_anejo_cristalino_platinum_700ml.jpg",
    nombre: "Tequila añejo cristalino Platinum",
    capacidad: "700 ml",
    precio: "$709.50 (c/u)",
    cantidad: "6 piezas",
    info: "100% Agave. (Pedido mínimo de una caja con 6 piezas)",
    ...
    organoleptica: {
      color: "Pajizo tenue y brillante.",
      aroma:
        "Su añejamiento en barrica le aporta notas amaderadas, con sensaciones que evocan frutos secos, notas sutiles de caramelo, especias y canela.",
      gusto:
        "Balance perfecto entre sabor y aroma, fino y duradero de agave selecto.",
    },
  },
  //----
  {
    foto: "img/productos/tequila_reposado_cristalino_platinum_700ml.jpg",
    nombre: "Tequila reposado cristalino Platinum",
    capacidad: "700 ml",
    precio: "$599.00 (c/u)",
    cantidad: "6 piezas",
    info: "100% Agave. (Pedido mínimo de una caja con 6 piezas)",
    ...
    organoleptica: {
      ...
      aroma:
        "Su paso por barrica le aporta claras y delicadas notas de aroma a vainilla, canela y especias.",
      gusto:
        "Balance perfecto entre sabor y aroma, fino y duradero de agave selecto.",
    },
  },
